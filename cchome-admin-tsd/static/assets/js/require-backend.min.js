...
require.config({
    ...
    paths: {
        ...
        'bootstrap-timepicker': '../libs/bootstrap-timepicker/bootstrap-timepicker.min',
    ...
    var Table = {
        ...
        api: {
            ...
            bindevent: function (table) {
                ...
                //   // 批量详情按钮事件
                //   $(toolbar).on('click', Table.config.infobtn, function () {
                //     var that = this;
                //     //循环弹出多个编辑框
                //     $.each(table.bootstrapTable('getSelections'), function (index, row) {
                //         var url = options.extend.info_url;
                //         row = $.extend({}, row ? row : {}, {ids: row[options.pk]});
                //         var url = Table.api.replaceurl(url, row, table);
                //         Fast.api.open(url, __('Info'), $(that).data() || {});
                //     });
                // });
            ...
            formatter: {
                ...
                operate: function (value, row, index) {
                    ...
                    // if (options.extend.info_url !== '' && names.indexOf('info') === -1) {
                    //     buttons.push({
                    //         name: 'del',
                    //         icon: 'fa fa-info',
                    //         title: __('Info'),
